...
exports = module.exports = app => {
  ...
  app.get('/blog/:categorySlug?', getController({ name : 'blogController', method: 'get' }));
  app.get('/blog/post/:postSlug', getController({ name : 'postController', method: 'get' }));
  app.get('/contact', getController({ name : 'contactController', method: 'get' }));
  app.post('/contact', getController({ name : 'contactController', method: 'post' }));
